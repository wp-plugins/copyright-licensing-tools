...
function icopyright_horizontal_toolbar() {
  ...
  //publication id @since 1.3
  $toolbar = icopyright_return_publication_variable();   
...
NOTICE;
  ...
  //include publication id javascript, @since 1.3
  $publication_id = icopyright_return_publication_variable();  
      return $publication_id.$icn;
  }
...
function icopyright_return_publication_variable() {
  //get publication id and ez_excerpt setting from options table from icopyright_admin array
  $admin_option = get_option('icopyright_admin');
  //assign publication id
  $pub_id_no = $admin_option['pub_id'];
