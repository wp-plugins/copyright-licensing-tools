...
<table class="form-table">
  ...
  <tr align="top">
    ...
    <td>
      <fieldset>
        <input id="icopyright_display_on_pages" name="icopyright_display_on_pages" type="checkbox" <?php if($icopyright_option['display_on_pages'] == 'yes') print 'checked="checked"'; ?> value="yes">
