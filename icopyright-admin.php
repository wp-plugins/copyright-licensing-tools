...
<h3>Account:</h3>
<p>
  We need information about your site, and how to reach you, so that the system operates properly and so we can
  send you money generated by your site.
</p>
...
<div id='advance_setting' style="display:none">
  <table class="form-table">
    ...
    <tr valign="top">
      ...
      <td><input type="text" name="icopyright_pubid" style="width:200px" value="<?php $icopyright_pubid = $icopyright_option['pub_id']; echo $icopyright_pubid; ?>"/></td>
    </tr>
    </tbody>
    <tr valign="top">
